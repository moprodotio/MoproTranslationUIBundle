...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TranslationUI = __webpack_require__(177);

	var _TranslationUI2 = _interopRequireDefault(_TranslationUI);
	...
	var UI_FILTER_SEARCH = 'ui_filter_search';
	...
	var UI_FILTER_DOMAIN = 'ui_filter_domain';
	...
	var UI_FILTER_NEW = 'ui_filter_new';
	...
	var UI_FILTER_NOT_TRANSLATED = 'ui_filter_not_translated';
	...
	var UI_MESSAGE_UPDATE = 'ui_message_update';
	...
	var UI_MESSAGE_UPDATED = 'ui_message_updated';
	function uiMessageUpdated() {
	    return {};
	}

	var UI_REFRESH = 'ui_refresh';
	function uiRefresh(indexURL, updateURL) {
	    return function (dispatch) {
	        ...
	        return fetch(indexURL, request).then(function (response) {
	            return response.json();
	        }).then(function (json) {
	            return dispatch(uiRefreshing(json));
	        });
	    };
	}

	var UI_REFRESHING = 'ui_refreshing';
	...
	var store = createStoreWithMiddleware(translationUIReducer);

	var container = document.getElementById('mopro_translation_container');
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    { store: store },
	    _react2.default.createElement(_TranslationUI2.default, null)
	), container);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(159),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Filters = function (_Component) {
	    ...
	    function Filters(props) {
	        ...
	        _this.filterNew = _this.filterNew.bind(_this);
	        _this.filterNotTranslated = _this.filterNotTranslated.bind(_this);
	        _this.filterDomain = _this.filterDomain.bind(_this);
	    ...
	    _createClass(Filters, [{
	        key: 'filterNew',
	        value: function filterNew(e) {
	            this.props.filterNew(e.target.checked);
	        }
	    }, {
	        key: 'filterNotTranslated',
	        value: function filterNotTranslated(e) {
	            this.props.filterNotTranslated(e.target.checked);
	        }
	    }, {
	        key: 'filterDomain',
	        value: function filterDomain(e) {
	        ...
	        value: function render() {
	            var domains = [];
	            domains.push(_react2.default.createElement('option', null));
	            var _iteratorNormalCompletion = true;
	            var _didIteratorError = false;
	            var _iteratorError = undefined;

	            try {
	                for (var _iterator = this.props.domains[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var option = _step.value;

	                    domains.push(_react2.default.createElement(
	                        'option',
	                        null,
	                        option
	                    ));
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'label',
	                                { htmlFor: 'filter_domains' },
	                                'Domain '
	                            ),
	                            _react2.default.createElement(
	                                'select',
	                                { id: 'filter_domains', onChange: this.filterDomain, className: 'form-control' },
	                                domains
	                            )
	                        ),
	                        ' ',
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement('input', { className: 'form-control', onKeyDown: this.filterSearch })
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'form-group' },
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    null,
	                                    ' ',
	                                    _react2.default.createElement('input', { type: 'checkbox', checked: this.props.filterNewChecked, onClick: this.filterNew }),
	                                    ' Show Only new '
	                                )
	                            )
	                        ),
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    null,
	                                    ' ',
	                                    _react2.default.createElement('input', { type: 'checkbox', checked: this.props.filterNotTranslatedChecked, onClick: this.filterNotTranslated }),
	...
	var MessagesTableRow = function (_Component2) {
	    _inherits(MessagesTableRow, _Component2);

	    function MessagesTableRow(props) {
	        _classCallCheck(this, MessagesTableRow);

	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(MessagesTableRow).call(this, props));

	        _this2.onBlur = _this2.onBlur.bind(_this2);
	        return _this2;
	    }

	    _createClass(MessagesTableRow, [{
	        key: 'onBlur',
	...
	var MessagesTable = function (_Component3) {
	    _inherits(MessagesTable, _Component3);

	    function MessagesTable() {
	        _classCallCheck(this, MessagesTable);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(MessagesTable).apply(this, arguments));
	    }
	...
	var TranslationUI = function (_Component4) {
	    _inherits(TranslationUI, _Component4);

	    function TranslationUI(props) {
	        _classCallCheck(this, TranslationUI);

	        var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(TranslationUI).call(this, props));

	        _this4.filterNew = _this4.filterNew.bind(_this4);
	        _this4.filterNotTranslated = _this4.filterNotTranslated.bind(_this4);
	        _this4.filterDomain = _this4.filterDomain.bind(_this4);
	        _this4.filterSearch = _this4.filterSearch.bind(_this4);
	        _this4.updateMessage = _this4.updateMessage.bind(_this4);
	        return _this4;
	    }

	    _createClass(TranslationUI, [{
	        key: 'filterNew',
	        value: function filterNew(doFilter) {
	            this.props.dispatch(this.props.toggleFilterNew(doFilter));
	        }
	    }, {
	        key: 'filterNotTranslated',
	        value: function filterNotTranslated(doFilter) {
	            this.props.dispatch(this.props.toggleFilterNotTranslated(doFilter));
	        }
	    }, {
	        key: 'filterSearch',
	        value: function filterSearch(search) {
	            this.props.dispatch(this.props.funcFilterSearch(search));
	        }
	    }, {
	        key: 'filterDomain',
	        value: function filterDomain(domain) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(Filters, { domains: this.props.domains,
	                ...
	                _react2.default.createElement(MessagesTable, { updateMessage: this.updateMessage, locales: this.props.locales, messages: this.props.shownMessages })
	            );
	        }
	    }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProp)(TranslationUI);
